...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    var GB_ROOT_DIR = "../skin/";
	 ...
	 <script type="text/javascript" src="../scripts/common.js"></script>
		...
		<script type="text/javascript">
			...
			function showBranch(){
			  Progress('<%= MipWebJSPUi.mipweb_user_showbranch_1 %>','<%= MipWebJSPUi.mipweb_user_showbranch_2 %>');
			  BranchAction.showGroup(branchid,
					{
						...
						errorHandler:function(errorString, exception) {
							CloseProgress();
						    DHalert("<%= MipWebJSPUi.mipweb_user_showbranch_3 %>"+errorString);
						}
					});
			}
	...
	<body onkeydown="if(event.keyCode=='13'&&event.srcElement.type!='textarea') return false;">
		...
		<div class="up_subtitle">
			<span><%= MipWebJSPUi.mipweb_user_showbranch_4 %></span>
		</div>
		<table width="620" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="26%">
					<%= MipWebJSPUi.mipweb_user_showbranch_5 %>
				</td>
			...
			<tr>
				...
				<td width="26%">
					<%= MipWebJSPUi.mipweb_user_showbranch_6 %>
				</td>
