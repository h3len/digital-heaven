 ...
 //var pageid = "<%=request.getParameter("pageid") != null ? request.getParameter("pageid") : "1"%>";
  ...
  function getuserbyenterpriseid(){
    ...
    BranchAction.getRootBranchs(
			 	function(objXml){
					DisplayTransformedXML(1, objXml, "xslt/admin_ctcc_branchsms.xsl",document.getElementById("divlist"));
		 			CloseProgress();
				}
			);	
  	}
	...
	parent.location.href="admin_enterprise_smsmanager.jsp?enterpriseid="+enterpriseid;
	}
		function closemenu(){
...
<div id="center_nav_box">
	<div id="center_nav">您现在所在位置 >> 移动邮件设置 >> 企业管理短信</div>
</div>	
<div id="mainbox">
