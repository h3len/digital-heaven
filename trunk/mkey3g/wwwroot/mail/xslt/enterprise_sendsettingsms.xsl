...
<tr><td width="16"><img src="../skin/default/images/text_icon.gif" /></td><td>提醒类型：</td><td></td><td><input type="radio"  id="sms" name="alerttype" disabled = "false">
<xsl:choose>
...
<input type="button" style="cursor:pointer;" id="btn1" class="button_6" value="发送设置短信 "  onclick="sendsettingsms()" />	</td></tr>
</table>
