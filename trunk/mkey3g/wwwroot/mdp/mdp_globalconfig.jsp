...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script src="/dwr/interface/GlobalConfig.js" type="text/javascript"></script>
			...
			Progress("Loading....");
				GlobalConfig.getGlobalConfig(
				{
					callback:function(objXml){
						...
						DisplayTransformedXML(1, objXml, "/xslt/mdp_globalconfig.xsl",document.getElementById("divContent"));
						CloseProgress();
					},
