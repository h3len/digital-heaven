...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <table width="100%" class="border" cellpadding="5" cellspacing="0">
      <tr class="list_title_bg">
      	<td align="center" width="10%" class="list_title_bg"><a href="javascript:checkall();" >全选</a> | <a href="javascript:inverse();" >反选</a></td>
        <td width="15%"><div class="href_12px_blue_bold">序号</div></td>
        <td width="25%"><div class="href_12px_blue_bold">用户名</div></td>        
        <td width="25%"><div class="href_12px_blue_bold">管理集团/部门</div></td>
     <!--   <td width="20%"><div class="href_12px_blue_bold">创建日期</div></td>    --> 
      ...
      <!--应用模板结束-->
      <tr>
		<td colspan="6" align="center" class="page"> 共<font class="bolderred"> <xsl:value-of select="/root/pagenumlist/@totalsize" /> </font>条记录 共<font class="bolderred"> <xsl:value-of select="/root/pagenumlist/@totalpage" /> </font>页 当前第<font class="bolderred"> <xsl:value-of select="/root/pagenumlist/@currentpage" /> </font>页 
  ...
  <xsl:template match="user">
   <tr onmouseover="this.className='tr_over';" onmouseout="this.className='tr_out';">
    ...
    <td>
     ...
     -->
    <td>
      <input type="button" class="button_4" value="退出角色">
