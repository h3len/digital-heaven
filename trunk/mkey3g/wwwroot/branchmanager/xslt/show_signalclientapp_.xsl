...
<td>
	...
	<tr>
		...
		<td width="10%" class="list_title_bg"><div align="center"><span class="href_12px_blue_bold">短信配额</span></div></td>
		<td width="10%" class="list_title_bg"><div align="center"><span class="href_12px_blue_bold">短信频率</span></div></td>	
		<td width="10%" class="list_title_bg"><div align="center"><span class="href_12px_blue_bold">彩信配额</span></div></td>	
		<td width="10%" class="list_title_bg"><div align="center"><span class="href_12px_blue_bold">彩信频率</span></div></td>	
		<td width="15%" class="list_title_bg"><div align="center"><span class="href_12px_blue_bold">设置</span></div></td>
		</tr>
	   <!--应用模板开始-->
    ...
    <xsl:when test="@iscurrentpage='false'">
  	<font class="bolder" style="cursor:pointer;"><xsl:attribute name="onclick">javascript:ChangePage("<xsl:value-of select="@page" />");</xsl:attribute><xsl:value-of select="@page" /></font><xsl:text> </xsl:text>
		...
		<xsl:choose>
			...
			<td><div align="center">
				<xsl:value-of select="@smslimit" /></div>
			</td>
			<td><div align="center">
				<xsl:value-of select="@mmslimit" /></div>
			</td>
			<td><div align="center">
				<xsl:value-of select="@smsbyday" /></div>
			</td>
			<td><div align="center">
				<xsl:value-of select="@mmsbyday" /></div>
			</td>
		   <td><div align="center">
	   					<input type="button" value="设置" class="button_2" onclick="config_limit('{@id}')"/>
					</div></td>
