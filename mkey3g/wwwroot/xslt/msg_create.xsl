...
<tr><td align="right" width="30%">部门名称：</td><td><input type="text" id="catalogname"/><span class="star"> *</span></td></tr>
<tr><td align="right">备 注：</td><td><input type="text" id="comment"/><span class="star"> </span></td></tr>
