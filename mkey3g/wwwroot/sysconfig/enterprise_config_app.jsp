	...
	function getclientapplist(enterpriseid,pageid){
				...
				MipClientAppAction.getClientAppList(enterpriseid,pageid,{
						callback:function(objXml) {
							CloseProgress();
								DisplayTransformedXML(1, objXml, "../branchmanager/xslt/show_signalclientapp.xsl",document.getElementById("divlist"));
						},
...
<div id="center_nav_box">
	<div id="center_nav">您现在所在位置 >> 配置管理 >> 业务系统配置 </div>
</div>	
<div id="mainbox">
		<div class="center_list_box">
				...
				<div>
							<div id="appconfig"> 
									<div style="text-align:left" id="addapp">
										<input type="button" class="button_6" value="添加业务系统" onclick="addclientapp()"/> 
									</div>
									<div id ="divlist"></div>
							</div>
			</div>
